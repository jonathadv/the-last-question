      ...
      <div className="App">
        ...
        <link href="https://fonts.googleapis.com/css?family=VT323" rel="stylesheet"/>
          ...
          <h1 className="App-title">> THE LAST QUESTION</h1>
            ...
            left until <a href="https://en.wikipedia.org/wiki/The_Last_Question" target="_blank"><i class="no-underline">The Last Question</i></a> to be asked for the first time.
        </p>
        <p className="quote">
